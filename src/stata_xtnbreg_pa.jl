...
"""
    stata_xtnbreg_pa(df; depvar, regs, idvar, timevar=nothing, k_disp=1.0,
...
Pipeline mirrors `stata_xtpoisson_pa`: pooled Poisson warm-start
...
"""
function stata_xtnbreg_pa(df; depvar::Symbol,
